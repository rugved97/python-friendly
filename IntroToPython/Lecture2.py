...
print(x)
x_str = str(x)
print("my fav number is", x, ".", "x=", x)  # Python adds space between two params separated by commas
print("my fav number is",
      x_str + ". " + "x=" + x_str)  # IF you don't want unnecessary spaces, type cast to string and concatenate
